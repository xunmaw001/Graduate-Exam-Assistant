<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="秘书电话" prop="mishudianhua">
          <el-input v-model="ruleForm.mishudianhua" 
              placeholder="秘书电话" clearable  :readonly="ro.mishudianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="秘书电话" prop="mishudianhua">
              <el-input v-model="ruleForm.mishudianhua" 
                placeholder="秘书电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='mishudianhua'){
            this.ruleForm.mishudianhua = obj[o];
	    this.ro.mishudianhua = true;
            continue;
          }
          if(o=='touxiang'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaoxuemishu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaoxuemishuCrossAddOrUpdateFlag = false;
						 this.parent.search();
