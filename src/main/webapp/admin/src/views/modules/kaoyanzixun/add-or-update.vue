<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="资讯编号" prop="zixunbianhao">
            <el-input v-model="ruleForm.zixunbianhao" 
                placeholder="资讯编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zixunbianhao" label="资讯编号" prop="zixunbianhao">
              <el-input v-model="ruleForm.zixunbianhao" 
                placeholder="资讯编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资讯标题" prop="zixunbiaoti">
          <el-input v-model="ruleForm.zixunbiaoti" 
              placeholder="资讯标题" clearable  :readonly="ro.zixunbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资讯标题" prop="zixunbiaoti">
              <el-input v-model="ruleForm.zixunbiaoti" 
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zixunneirong" label="资讯内容" prop="zixunneirong">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../ssmv26k3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
