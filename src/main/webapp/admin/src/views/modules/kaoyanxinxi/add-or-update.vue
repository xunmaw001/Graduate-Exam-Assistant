<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考研专业" prop="kaoyanzhuanye">
          <el-input v-model="ruleForm.kaoyanzhuanye" 
              placeholder="考研专业" clearable  :readonly="ro.kaoyanzhuanye"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考研专业" prop="kaoyanzhuanye">
              <el-input v-model="ruleForm.kaoyanzhuanye" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="确认时间" prop="querenshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.querenshijian" 
                type="date"
                :readonly="ro.querenshijian"
                placeholder="确认时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.querenshijian" label="确认时间" prop="querenshijian">
              <el-input v-model="ruleForm.querenshijian" 
                placeholder="确认时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='kaoyanzhuanye'){
            this.ruleForm.kaoyanzhuanye = obj[o];
	    this.ro.kaoyanzhuanye = true;
            continue;
          }
          if(o=='kaoshikemu'){
	    ...
	    this.ro.baomingshijian = true;
          ...
          if(o=='querenshijian'){
            this.ruleForm.querenshijian = obj[o];
	    this.ro.querenshijian = true;
            continue;
          }
          if(o=='luqufenshu'){
            this.ruleForm.luqufenshu = obj[o];
	    this.ro.luqufenshu = true;
            continue;
          }
          if(o=='xiangqing'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmv26k3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `kaoyanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.kaoyanxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
